...
- (instancetype)initWithCornerBorderWithFrame:(CGRect)rect {
    self = [super initWithFrame:rect];
    if (self) {
        UIBezierPath* path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(rect.size.width / 2, rect.size.height / 2) radius:rect.size.width / 2 startAngle:0 endAngle:2*M_PI clockwise:YES];
